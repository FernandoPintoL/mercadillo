...
const model_service = AlmacenService;
...
const validateDireccion = (e) => {
    ...
    if (!validacion.validarDireccion(e.target.value)) {
        datas.detalleError = 'La direccion debe tener más de 2 caracteres, sin caracteres especiales.';
    } else {
        form.detalle = e.target.value;
        datas.detalleError = '';
    }
